...
{
    public class KullaniciHaftalıkEtkinlikGetirHandler : BaseHandler, IRequestHandler<KullaniciHaftalikEtkinlikGetirRequest, IList<KullaniciEtkinligiGetirResponse>>
    {
        public KullaniciHaftalıkEtkinlikGetirHandler(
            IMapper mapper,
